...
public class ChatUIGroup implements MessageObserver {
    ...
    class GroupChatWindow extends JFrame {
        ...
        public GroupChatWindow(String groupName) {
            ...
            JButton fileListButton = new JButton("群文件");
        ...
        private void showFileListDialog() {
            JDialog dialog = new JDialog(this, "群文件", true);
            dialog.setLayout(new BorderLayout());
            dialog.setSize(500, 400);
            dialog.setLocationRelativeTo(this);

            // 发送群文件列表请求
            client.sendMessage("/filelist " + groupName + " group");
                    ...
                    if (message.startsWith("FILELIST:")) {
                        SwingUtilities.invokeLater(() -> {
                            ...
                            if (message.equals("FILELIST:EMPTY")) {
                                fileListPanel.add(new JLabel("暂无群文件"));
                            } else {
                                ...
                                for (String fileInfo : files) {
                                    ...
                                    if (parts.length >= 5) {
                                        ...
                                        infoPanel.add(new JLabel("上传者: " + sender + "  大小: " + fileSize/1024 + "KB"));
